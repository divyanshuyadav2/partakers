        ...
        <div class="space-y-4">
                                    ...
                                    <div class="grid text-white space-y">
                                        ...
                                        <div>
                                            <div class="flex gap-4 items-center">
                                                ...
                                                <span
                                                    class="bg-green-400 font-normal">{{ $skill['Profc_Lvl'] }}/5</span>
                                            </div>
                                    ...
                                    <div class="flex flex-wrap gap-4 mt-1">
                                        @if ($reference->Refa_Emai)
                                            <a href="mailto:{{ $reference->Refa_Emai }}"
                                                class="text-blue-400 text-sm hover:text-blue-300 flex items-center gap-1 font-normal">
                                                <i class="bi bi-envelope"></i> {{ $reference->Refa_Emai }}
                                            </a>
                                        @endif
                                        @if ($reference->Refa_Phon)
                                            <a href="tel:{{ $reference->Refa_Phon }}"
                                                class="text-blue-400 hover:text-blue-300 flex items-center gap-1 text-sm font-normal">
                        ...
                        @foreach ($bankAccounts as $bank)
                            <div class=" border-l-2 border-slate-600 pl-3">
                                ...
                                <div class="space-y">
                                    <div class="{{ $fieldWrapperClass }}">
                                        @if ($bank->Prmy)
                                            <span class="p-1 rounded-full bg-yellow-400" title="Primary Bank"></span>
                                        @endif
                                        <span class="{{ $labelClass }}">
                                    ...
                                    <div class="{{ $fieldWrapperClass }}">
                                        ...
                                        <span class="{{ $dataClass }}">{{ $bank->Bank_Brnc_Name ?? '-' }}</span>
                                    </div>
                                    <div class="{{ $fieldWrapperClass }}">
                                    ...
                                    <div class=" border-slate-700">
                                        ...
                                        <div class="flex gap-4 flex-wrap">
                                            @foreach ($bank->attachments as $attachment)
                                                <a href="{{ Storage::url($attachment->Atch_Path) }}" target="_blank"
            ...
            @else
                <div class="figma-card bg-slate-600/40">
                    ...
                    <p class="text-slate-500 "><i class="bi bi-info-circle"></i> No notes added yet.</p>
                </div>
            @endif
        </div>
    </div>
